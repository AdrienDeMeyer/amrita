...
<section class="banner-area relative about-banner" id="home">
    <img class="cta-img img-fluid" src="{{ URL::asset('img/cta-img.png') }}" alt="">
    ...
    <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                ...
                <p class="link-nav"><a href="{{ route('accueil') }}">Accueil </a>
                    <span class="lnr lnr-arrow-right"></span> <a href="{{ route('contact') }}">
                        Contact</a></p>
            </div>
        </div>
    </div>
